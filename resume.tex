...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{secondaryColor}\textit{Derek Provance - Resume - Page \thepage\ of \ref*{TotPages}}
}{}{} 
\makeatother
...
\newcommand{\jobentry}[4]{
    \begin{onecolentry}
        \noindent
        \begin{tabularx}{\textwidth}{@{}X>{\raggedleft\arraybackslash}p{3.5cm}@{\hspace{0.2cm}}}
            \begin{tabular}[t]{@{}l@{}}
                \textbf{#1}\\
                \textit{#2}
            \end{tabular} &
...
\newcommand{\placelastupdatedtext}{
  \AddToShipoutPicture*{
    \put(
        \LenToUnit{\paperwidth-2 cm-0.2 cm-1cm},
        \LenToUnit{\paperheight-1.0 cm}
    ){\vtop{{\null}\makebox[0pt][c]{
        \small\color{secondaryColor}\textit{Last updated: \monthname\ \the\year}
    }}}
  }
}
