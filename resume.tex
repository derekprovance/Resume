...
\end{onecolentry}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Delivered enterprise \textbf{HIPAA-compliant} workflow platform, architecting scalable solution using \textbf{Node.js}/\textbf{TypeScript}, \textbf{Temporal.io}, and \textbf{Redis} with \textbf{AI-assisted development}
