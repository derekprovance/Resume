...
Spring \textbullet{}  ReactJS  \textbullet{} Bash \textbullet{} Docker \\
...
\begin{tightemize}
\vspace{\topsep}
\item Architect \textbf{AWS} ecosystems for clients using technologies like \textbf{Beanstalk, RDS, Route 53, and DynamoDB.}
\item Build \textbf{RESTful APIs} using \textbf{Spring} or \textbf{API Gateway}
\item Designed customer databases for both \textbf{SQL} and \textbf{No-SQL} environments using caching layers for efficient transactions
\end{tightemize}
\sectionsep
