...
% PDF/A-1b compliance with enhanced metadata
...
% Enhanced PDF metadata and display settings
\hypersetup{
    pdftitle={Derek Provance - Software Architect Resume},
    pdfauthor={Derek Provance},
    pdfsubject={Resume - Software Architect with 11+ years experience in cloud-native architectures and enterprise-scale systems},
    pdfkeywords={Software Architect, Software Engineer, AWS, Cloud Architecture, TypeScript, Node.js, JavaScript, Serverless, Lambda, DynamoDB, SQL, PostgreSQL, Aurora, CI/CD, DevOps, Docker, API Design, Microservices, Technical Leadership, HIPAA Compliance, Redis, Temporal.io, Nest.JS, GitHub Actions, Terraform, Enterprise Systems, SaaS, Full Stack Developer, Agile},
...
\begin{header}
    ...
    \normalsize
    913.228.2196 | \hrefWithoutArrow{mailto:me@derek.pro}{me@derek.pro} | Denver, CO \\
    \hrefWithoutArrow{https://linkedin.com/in/derekprovance}{LinkedIn} | \hrefWithoutArrow{https://github.com/derekprovance}{GitHub} | \hrefWithoutArrow{https://derek.pro}{derek.pro}
\end{header}
...
\begin{onecolentry}
    \textbf{Software Architect} with \textbf{11+ years} building \textbf{enterprise-scale systems} for \textbf{SaaS}. Expert in \textbf{cloud-native architectures}, \textbf{AI-assisted development}, and leading \textbf{cross-functional teams} through complex migrations. Proven track record of accelerating delivery by \textbf{40-75\%} while maintaining \textbf{zero-downtime operations}.
\end{onecolentry}
...
\begin{itemize}[leftmargin=0.5cm]
    ...
    \item \textbf{Cloud \& Infrastructure:} AWS (Lambda, API Gateway, DynamoDB, S3, EC2, ECS, CloudFormation), Docker, CI/CD Pipelines, Terraform, GitHub Actions
    \item \textbf{Programming:} TypeScript, JavaScript, Node.js, Nest.JS, Temporal.io, Java, SQL, Spring Boot
...
\end{onecolentry}
    ...
    \jobentry{Software Architect}{Intellistack}{Mar 2025 - Aug 2025}{Remote}

    \vspace{0.10cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Delivered enterprise \textbf{HIPAA-compliant} workflow platform using \textbf{Node.js}/\textbf{TypeScript}, \textbf{Redis} and \textbf{Temporal.io}, architecting scalable solution with \textbf{AI-assisted development}
    ...
    \begin{onecolentry}
        \begin{highlights}
            ...
            \item Rescued million-dollar client relationship by debugging complex \textbf{SOAP API} integration with partner.
        \end{highlights}
    \end{onecolentry}
