...
\usepackage[
    ...
    pdfcreator={LaTeX},
    pdfsubject={Resume},
    pdfkeywords={Software Engineer, Software Architect, AWS, Full Stack Developer, Cloud Architecture, TypeScript, Node.js, JavaScript, Serverless, Lambda, DynamoDB, SQL, MySQL, PostgreSQL, Aurora, CI/CD, DevOps, Docker, API Design, Microservices, Technical Leadership, Agile, HIPAA Compliance, Redis, Temporal.io, Nest.JS, GitHub Actions, Terraform},
